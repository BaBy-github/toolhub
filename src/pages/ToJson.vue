        ...
        <div v-show="showOutput" class="relative card" :style="{ width: rightWidth }">
          ...
          <div class="h-[60vh]">
            ...
            <div
              ...
              class="h-full overflow-auto text-xs leading-tight json-tree-compact"
            >
            ...
            <div class="absolute right-2 bottom-2">
              <div
                class="flex rounded-lg border overflow-hidden bg-white dark:bg-gray-800 dark:border-gray-700"
              >
                <button
                  :class="[
                    'px-2 py-1 text-xs',
                    viewMode === 'code' ? 'bg-blue-600 text-white' : 'btn-ghost',
                  ]"
                  @click="viewMode = 'code'"
                >
                  {{ t('common.code') }}
                ...
                <button
                  :class="[
                    'px-2 py-1 text-xs',
                    viewMode === 'tree' ? 'bg-blue-600 text-white' : 'btn-ghost',
                  ]"
                  @click="viewMode = 'tree'"
                >
                  {{ t('common.tree') }}
                ...
                <button
                  :class="[
                    'px-2 py-1 text-xs',
                    viewMode === 'columns' ? 'bg-blue-600 text-white' : 'btn-ghost',
                  ]"
